...
.bg-card {
  --tw-bg-opacity: 1;
  background-color: rgb(21 20 27 / var(--tw-bg-opacity, 1));
}

.bg-dominant {
  --tw-bg-opacity: 1;
  background-color: rgb(243 156 61 / var(--tw-bg-opacity, 1));
}
...
.bg-subdominant {
  --tw-bg-opacity: 1;
  background-color: rgb(56 185 138 / var(--tw-bg-opacity, 1));
}
...
.shadow-glow {
  --tw-shadow: 0px 12px 40px rgba(0,0,0,0.4);
